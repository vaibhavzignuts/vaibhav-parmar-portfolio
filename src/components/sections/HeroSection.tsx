...
export function HeroSection({ className, id }: { className?: string; id?: string }) {
  ...
  const nameParts = 'Vaibhav Parmar'.split('');
  ...
  return (
    ...
    >
      <div className="container relative z-10 mx-auto max-sm:mt-10">
        ...
        >
          A <span className="font-semibold text-primary">Software Engineer</span> specializing in
          React.js & React Native, based in India, crafting seamless user experiences.
        </motion.p>
        ...
        >
          ...
          >
            ...
            >
              <a
                href="/resume_vaibhav_parmar.pdf"
                target="_blank"
