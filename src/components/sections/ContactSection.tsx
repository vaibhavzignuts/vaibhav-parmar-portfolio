...
const SOCIAL_LINKS: SocialLink[] = [
  {
    href: 'mailto:vp007rajput@gmai.com',
    icon: Mail,
    text: 'vp007rajput@gmai.com',
  },
  {
  ...
  { href: 'https://github.com/vaibhavzignuts', icon: GithubIcon, text: 'vaibhavparmar' },
  { href: 'tel:+91XXXXXXXXXX', icon: Phone, text: '+91 XXXXXXXXXX' },
];
