      ...
      >
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="flex-1 space-y-4">
            <div>
              <h3 className="text-2xl font-bold">Vaibhav Parmar</h3>
              <p className="text-muted-foreground">Software Engineer & Technical Writer</p>
            </div>

            <p className="text-muted-foreground leading-relaxed">
              Passionate about building privacy-focused applications and seamless user experiences.
              I specialize in React.js, React Native, Next.js, and mobile development. Always
              exploring new tools and techniques to create better digital experiences.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              <Button variant="outline" size="sm" asChild>
                <Link
                  href="https://www.linkedin.com/in/vaibhav-parmar/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <Button variant="outline" size="sm" asChild>
                <Link
                  href="https://github.com/vaibhavparmar"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <Button variant="outline" size="sm" asChild>
                <Link href="mailto:vaibhavparmar.dev@gmail.com">
