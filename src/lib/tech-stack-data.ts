...
export const TECH_STACK_DETAILS: TechDetails = {
  ...
  'tanstack query': {
    icon: 'simple-icons:tanstackquery',
    color: '#FF4154',
    name: 'TanStack Query',
  },
  supabase: { icon: 'simple-icons:supabase', color: '#3ECF8E', name: 'Supabase' },
  ckeditor: { icon: 'simple-icons:ckeditor', color: '#0287D0', name: 'CKEditor' },
